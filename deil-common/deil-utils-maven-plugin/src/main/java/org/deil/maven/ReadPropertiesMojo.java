...
/**
 * The read-properties goal reads property files and URLs and stores the properties as project properties. It
 ...
 */
@Mojo(name = "read-properties", defaultPhase = LifecyclePhase.NONE, requiresProject = true, threadSafe = true)
public class ReadPropertiesMojo extends AbstractJasyptMojo {
     ...
     */
    @Parameter(defaultValue = "${jasyptPassword}")
    protected String jasyptPassword;
