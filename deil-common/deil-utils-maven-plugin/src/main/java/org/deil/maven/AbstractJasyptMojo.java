...
abstract class AbstractJasyptMojo extends AbstractMojo {
     ...
     */
    @Parameter(property = "algorithm", defaultValue = "PBEWithMD5AndDES")
    private String algorithm = "PBEWithMD5AndDES";

    /**
     * Sets the size of the pool of encryptors to be created.
     */
    @Parameter(property = "poolSize", defaultValue = "4")
    private int poolSize = 4;

    /**
     * Sets the number of hashing iterations applied to obtain the encryption key.
     */
    @Parameter(property = "keyObtentionIteration", defaultValue = "1000")
    private int keyObtentionIteration = 1000;
     ...
     */
    @Parameter(property = "ivGeneratorClassName", defaultValue = "org.jasypt.iv.NoIvGenerator")
