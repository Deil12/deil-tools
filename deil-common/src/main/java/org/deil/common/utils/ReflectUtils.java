...
public class ReflectUtils {
    ...
    public static Optional<Method> getMethodByAnnotation(Class<?> clazz, Class<? extends Annotation> annotationType) {
    ...
    public static List<Class<?>> getClassListByAnnotation(String packageName, Class<? extends Annotation> annotationClass) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("get class from package %s by annotation %s error", packageName, annotationClass.getSimpleName()), e);
        }
        return classList;
    }
