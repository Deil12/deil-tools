...
public class PropertiesUtil {
    ...
    public static void main(String[] args) {
        // 注意路径问题
        String properties_1 = getProperties_1("backgroundService/TelAutoDecodeService/src/main/resources/properties/BussinessAll/appConfig.properties", "wechat_appid");
        System.out.println("wechat_appid = " + properties_1);
        getProperties_1("com/test/config/config.properties");
        System.out.println("*********************************************");
        // 注意路径问题
        String properties_2 = getProperties_2("/properties/BussinessAll/appConfig.properties", "CANSendFlag");
