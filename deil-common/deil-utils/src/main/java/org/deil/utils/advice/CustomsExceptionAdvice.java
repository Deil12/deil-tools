...
@ControllerAdvice
public class CustomsExceptionAdvice extends ResponseEntityExceptionHandler {
    private Logger log = LoggerFactory.getLogger(CustomsExceptionAdvice.class);

    private final ObjectMapper mapper;
    public CustomsExceptionAdvice(ObjectMapper mapper) {
        this.mapper = mapper;
    }
    ...
    public ResponseEntity<ServiceRespBody> customsMoveExceptionHandler(@RequestAttribute String logId, Exception ex) {
