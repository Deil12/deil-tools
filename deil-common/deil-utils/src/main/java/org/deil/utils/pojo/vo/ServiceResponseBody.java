package org.deil.utils.pojo.vo;
...
public abstract class ServiceResponseBody implements Serializable {
    ...
    protected ServiceResponseBody(String logId, Integer code, String message) {
        this.logId = logId;
        this.code = code;
    ...
    public boolean equals(Object o) {
        if (this == o) {
            return true;
        } else if (!(o instanceof ServiceResponseBody)) {
            return false;
        } else {
            ServiceResponseBody that = (ServiceResponseBody)o;
