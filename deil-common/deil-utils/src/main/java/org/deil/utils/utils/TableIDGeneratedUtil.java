...
//        List<Class<?>> entityClasses= ReflectUtil.getClassListByAnnotation(pack, javax.persistence.Entity.class);
//
...
//                Optional<Field> fieldByAnnotation = ReflectUtil.getFieldByAnnotation(clazz, idClass);
...
//
//            for (Class<? extends Annotation> idClass : ID_CLASS_LIST) {
//                Optional<Method> fieldByAnnotation = ReflectUtil.getMethodByAnnotation(clazz, idClass);
//                if (fieldByAnnotation.isPresent()) {
